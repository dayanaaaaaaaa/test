...
function uzzimetVardu(){
     minamaisVards = document.getElementById("vards").textContent.toUpperCase().trim()
...
function minetBurtu(burts){
    ...
    let atrada = -1
//Meklēšana, ka atrodas burts, tad atrada=0 
...
function parbauditBeigas(){
    if (dzivibas==0){ //Zaudēja
        ...
        let pogas = document.getElementsByTagName("burts")
        for (poga of pogas){
            poga.disabled=true
        }
        return
